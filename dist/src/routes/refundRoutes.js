...
const getRefundDetails_1 = __importDefault(require("../controllers/refundController/getRefundDetails"));
...
router.get("/getRefundDetails/:id_presale", verifyToken_1.default, (0, checkRoleAndPermission_1.default)(["ADMINISTRADOR", "COLABORADOR"]), getRefundDetails_1.default);
